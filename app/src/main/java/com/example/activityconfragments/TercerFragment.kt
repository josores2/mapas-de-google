...
class TercerFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener{
    ...
    private fun buscaGasolineras() {
        ...
        /*val coordenadas= LatLng(long,lati)
        val marcador= MarkerOptions().position(coordenadas).title("Estás aquí")
